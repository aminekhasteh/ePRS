...
path = './Thesis/UK_BioBank_7k_pheno/PRS_plink/sum_stats_1' ######################## 
m = [s for s in os.listdir(path) if ".tsv" in s][0]
dat = path +'/'+ m
sum_stat_dat = pd.read_csv(dat,sep='\t')

path1 = './Thesis/UK_BioBank_7k_pheno/'
...
path_to_save = './Thesis/UK_BioBank_7k_pheno/PRS_plink/sum_stats_1/' + m + '.txt' ####################
...
path_to_save_1 = './Thesis/UK_BioBank_7k_pheno/number_of_variants/' + m[:-4] + '.txt'
...
path_to_save_2 = './Thesis/UK_BioBank_7k_pheno/PRS_plink/GCLambda/' + m[:-4] + '.txt'
